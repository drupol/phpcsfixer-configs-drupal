 ...
 * @internal
 *
 * @covers \drupol\PhpCsFixerConfigsDrupal\Config\Drupal7
 */
final class Drupal7Test extends TestCase
{
    public function testConfigDefault(): void
    {
        $config = new \drupol\PhpCsFixerConfigsDrupal\Config\Drupal7();
        ...
        self::assertSame('drupal7', $config->getName());
